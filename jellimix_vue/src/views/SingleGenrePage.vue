  ...
  <div class="ms_album_single_wrapper ms_artist_single">
    ...
    <div class="album_single_data">
      <div class="album_single_img">
        <img :src="img_url || require(`../assets/images/genrs/${default_img}`)" alt="genre pic" class="img-fluid" />
      </div>
      <div class="album_single_text">
        <h2>{{genre.Name}}</h2>
        <div class="album_btn">
          <a href="#" class="ms_btn play_btn" @click="playAll"><span class="play_all"><img src="images/svg/play_all.svg"
                alt="" />Play All</span><span class="pause_all"><img src="images/svg/pause_all.svg"
                alt="" />Pause</span></a>
          <a href="#" class="ms_btn" @click="addToQueue"><span class="play_all"><img src="images/svg/add_q.svg"
    ...
    <div class="album_inner_list">
      <div class="album_list_wrapper">
        ...
        <!-- <ul v-for="(item,index) in genre_data" :key="index">
          <li>
            <a href="#"><span class="play_no">{{index+1}}</span><span class="play_hover"></span>
            </a>
          </li>
          ...
          <li class="text-center ms_more_icon">
            ...
            <ul class="more_option">
              <li>
                <a href="#"><span class="opt_icon"><span class="icon icon_fav"></span></span>Add To Favourites</a>
              </li>
              <li>
                <a href="#"><span class="opt_icon"><span class="icon icon_queue"></span></span>Add To Queue</a>
              </li>
              <li>
                <a href="#"><span class="opt_icon"><span class="icon icon_dwn"></span></span>Download Now</a>
              </li>
              <li>
                <a href="#"><span class="opt_icon"><span class="icon icon_playlst"></span></span>Add To Playlist</a>
              </li>
              <li>
                <a href="#"><span class="opt_icon"><span class="icon icon_share"></span></span>Share</a>
              </li>
            </ul>
          </li>
        </ul> -->
  ...
  export default {
    ...
    created() {
      ...
      this.getSingleGenreSongs(this.$route.params.id).then((res) => {
        ...
        this.pageContent = this.genre_data
      });
    },
    methods: {
