  ...
  <div class="ms_footer_wrapper">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6">
          <div class="footer_box">
            <h1 class="footer_title">jellimix music station</h1>
            <p>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="footer_box footer_app">
            ...
            /></a>
            <a href="#" class="foo_app_btn"
              ><img src="../assets/images/windows.jpg" alt="" class="img-fluid"
            /></a>
          </div>
        </div>
        <div class="col-lg-3 col-md-6">
    ...
    <div class="col-lg-12">
      <div class="ms_copyright">
        ...
        <p>
          Copyright &copy; 2018 <a href="#">The Jellimix Music Template</a>. All
          Rights Reserved.
        </p>
      </div>
    </div>
